...
const uint16_t BITMAP_BLUE_ICONS_BACK_ARROW_48_ID = 2;
const uint16_t BITMAP_BLUE_ICONS_NEXT_ARROW_48_ID = 3;
const uint16_t BITMAP_CANVA_ID = 4;
const uint16_t BITMAP_MONKEY_ID = 5;
